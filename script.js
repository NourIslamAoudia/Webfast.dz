...
const Questions_Fréquemment_Posées = document.getElementById(
  "Questions_Fréquemment_Posées"
);
    ...
    fetch("https://webfast-dz.vercel.app/pages/api/submit", {
      ...
      .catch((err) => {
        ...
        if (err.message.includes("Failed to fetch")) {
          ...
          errorMessage =
            "❌ Erreur de configuration du serveur. Contactez le support.";
        }
...
document.addEventListener("DOMContentLoaded", function () {
  if (typeof particlesJS !== "undefined") {
    ...
    console.warn("Particles.js non chargé - utilisation d'un fond statique");
